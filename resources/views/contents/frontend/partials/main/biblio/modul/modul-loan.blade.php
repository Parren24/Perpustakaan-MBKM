...
<section class="fact-statistics-section layanan-section ">
                ...
                <div class="card- border border-1 mb-3 lg-4 pb-2 rounded bg-opacity-75 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="card-body d-flex justify-content-center align-items-center flex-column">
                        <div class="p-4 align-items-center ">
                            <H3 class="text-center">Aturan Peminjaman Modul</H3>
                            <div class="p-5">
                                <li>Modul Perkuliahan hanya dipinjamkan paling lama 5 bulan</li>
                                <li>Modul Perkuliahan wajib dikembalikan tepat waktu sesuai waktu yang telah ditentukan</li>
                                <li>Anggota perpustakaan wajib menjaga kondisi modul yang dipinjam agar tetap baik dan tidak rusak.</li>
                                <li>Jika modul yang dipinjam hilang atau rusak parah, anggota wajib mengganti dengan modul yang sama atau membayar sesuai harga modul tersebut.</li>
                            </div>
                        </div>
                ...
                <div class="col-lg-8 col-md-6 col-12">
                    <div class="card border-1 ">
                        <div class="card-header text-white">
                            <h5 class="mb-0"><i class="fas fa-list me-2"></i>Daftar Modul untuk Dipinjam</h5>
                        </div>
                        <div class="card-body flex-column d-flex">
                            ...
                            <div class="d-flex justify-content-between align-items-center mt-4 flex-wrap">
                                <div class="mt-2 mt-md-0">
                                    <button type="button" class="btn btn-outline-danger rounded-pill px-4" id="resetLoanBtn">
        ...
        <div class="modal-dialog modal-dialog-centered ">
            <div class="modal-content ">
                <div class="modal-header">
                    <h5 class="modal-title" id="scanModalLabel"> <i class="fas fa-qrcode me-2"></i> Pindai QR Code</h5>
                    ...
                    <div class="row">
                        <div class="col-12 " id="reader-container">
                            ...
                            <div id="barcode-input-container" style="display: none;" class="mt-3 px-3">
                                <input type="text" id="barcodeInput" class="form-control form-control-lg text-center" placeholder="Gunakan scanner fisik ke barcode modul..." autocomplete="off">
                            </div>
                        </div>
    ...
    <script src="{{ asset('theme/js/ModulLoan.js') }}?v={{ time() }}"></script>
